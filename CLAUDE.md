# CLAUDE.md — Integrity Chimney Services LLC Project Rules
#
# PROJECT VARIABLES (filled 2026-04-30 via /prime Task 0A — sourced from initial-business-data.md):
...
Never embed third-party redirects that take users off the integritychimney.com domain.
...
custom BookingCalendar component (Calendly API under the hood — TBD before Phase 4).
...
description, Open Graph tags, LocalBusiness (HomeAndConstructionBusiness) schema markup, crawlable text
