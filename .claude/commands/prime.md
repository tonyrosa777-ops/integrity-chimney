# prime.md — Integrity Chimney Services LLC (project-instantiated)
# Generated 2026-04-30 from project-prime.md via /prime Task 0C.
# This is what /prime loads when invoked from this project folder.
#
# PROJECT VARIABLES (already substituted throughout this file):
#   BUSINESS_NAME      = Integrity Chimney Services LLC
#   DOMAIN             = integritychimney.com
#   BUSINESS_TYPE      = local trade service — chimney, masonry, and roofing contractor
#   LOCATION           = Bow, NH
...
#   BOOKING_ENGINE     = Calendly (TBD — confirm before Phase 4)
...
You are the orchestrator for the **Integrity Chimney Services LLC** (integritychimney.com) website build.
...
| Variable | Source |
|----------|--------|
| Integrity Chimney Services LLC | initial-business-data.md Section 1 |
| integritychimney.com | initial-business-data.md Section 1 |
| local trade service — chimney, masonry, and roofing contractor | initial-business-data.md Section 1 — one-phrase description |
| Bow, NH | initial-business-data.md Section 1 |
| TBD — high urgency (zero current online presence) | initial-business-data.md Section 7 |
| NH homeowners with wood-burning fireplaces, wood stoves, or aging chimneys; secondary: real estate agents needing pre-sale chimney inspections | initial-business-data.md Section 3 — specific, not generic |
| chimney cleaning, full masonry, rain caps, stainless steel liners, restoration, roofing, insurance & real estate inspections | initial-business-data.md Section 2 |
| establish first-ever web presence, generate inbound residential leads, support referral credibility | initial-business-data.md Section 5 |
| Calendly (TBD — confirm before Phase 4) | initial-business-data.md Section 5 — or "TBD — confirm before Phase 4" |
...
```bash
# Site
NEXT_PUBLIC_SITE_URL=https://integritychimney.com
...
19. Route structure — /service-areas/[city]:
    ...
    A. src/app/service-areas/page.tsx — index page
       ...
       - generateMetadata: title "Service Areas | Integrity Chimney Services LLC"
    ...
    C. src/app/service-areas/[city]/page.tsx — individual city page (SERVER component)
       ...
       - generateMetadata({ params }): unique title + description per city
         title: "[Service] in [City], [State] | Integrity Chimney Services LLC"
